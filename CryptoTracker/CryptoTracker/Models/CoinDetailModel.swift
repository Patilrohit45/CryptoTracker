...
URL : https://api.coingecko.com/api/v3/coins/bitcoin?localization=false&tickers=false&market_data=false&communit_data=false&developer_data=false&sparkline=false
 ...
 JSON RESPONSE :
 {
   ...
   "sentiment_votes_up_percentage": 80.79,
   "sentiment_votes_down_percentage": 19.21,
   "watchlist_portfolio_users": 1652407,
   "market_cap_rank": 1,
   "status_updates": [],
   "last_updated": "2024-08-19T05:17:24.817Z"
 }
...
struct CoinDetailModel:Codable{
    ...
    enum CodingKeys:String,CodingKey {
        ...
        case hashingAlgorithm = "hashing_alogorithm"
    }
