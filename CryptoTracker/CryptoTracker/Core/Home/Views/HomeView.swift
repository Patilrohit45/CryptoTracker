...
struct HomeView: View {
    ...
    @State private var showPortfolioView:Bool = false // to show portfolioView Shee
    ...
    private var allCoinLists: some View{
        List{
            ForEach(vm.allCoins){ coin in
                    CoinRowView(coin: coin, showHoldingsCoumn: false)
    ...
    private var portfolioCoinLists: some View{
        List{
            ForEach(vm.portfolioCoins){ coin in
                    CoinRowView(coin: coin, showHoldingsCoumn: true)
                    .listRowInsets(.init(top: 10, leading: 0, bottom: 10, trailing: 10))
                    .onTapGesture {
                        segue(coin: coin)
                    }
